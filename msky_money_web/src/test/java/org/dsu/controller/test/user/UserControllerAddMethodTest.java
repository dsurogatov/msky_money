...
@WebAppConfiguration
public class UserControllerAddMethodTest {
    ...
    @Test
    public void add_NameLoginFieldsAreNull_ShouldReturnValidationErrorsForFields() throws Exception {
    ...
    @Test
    public void add_NameLoginFieldsAreEmpty_ShouldReturnValidationErrorsForFields() throws Exception {
